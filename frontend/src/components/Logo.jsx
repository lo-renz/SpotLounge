...
const Logo = ({ username }) => {
    return (
        <div className='text-2xl font-bold text-[#1db954] flex gap-1 p-4'>
            <Link className='text-white p-1 bg-[#1db954] rounded-3xl' to='/home'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
